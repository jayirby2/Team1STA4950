...
plot(GAM_RR,
     ...
     xlab = c("Spin rate", "Velocity", "Induced Vertical Break (IVB)" ,"Horizontal Break (HB)",
              "TI", "Horizontal Plate Location", "Vertical Plate Location",
              "TI", "InitPosX", "InitPosZ")
)
...
plot(GAM_RR, select = 9, xlab = "InitPosX",
     scale = 0, ylim = c(-3,3), col = "navy",
     ylab = "Partial Effect on GIDP Probability")

plot(GAM_RR, select = 10, xlab = "InitPosZ",
     scale = 0, ylim = c(-3,3), col = "navy",
     ylab = "Partial Effect on GIDP Probability")
